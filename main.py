...
async def on_ready():
    while True:
        await client.change_presence(game=discord.Game(name="League of Legends"), status=discord.Status.online)
        await asyncio.sleep(60)
        await client.change_presence(game=discord.Game(name=" -help ", type=1, url='https://www.twitch.tv/ztutuh'), status='streaming')
        await asyncio.sleep(60)
        await client.change_presence(game=discord.Game(name="As baguncinhas do Geek World", type=3, status=discord.Status.dnd))
        await asyncio.sleep(60)
        await client.change_presence(game=discord.Game(name="As baguncinhas do Geek World", type=3, status=discord.Status.idle))
        await asyncio.sleep(60)
